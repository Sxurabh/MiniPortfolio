...
export const DeleteProjectModal = ({ isOpen, onClose, projectId }: DeleteProjectModalProps) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-background/80 backdrop-blur-sm" onClick={onClose}>
      <div className="relative w-full max-w-md p-8 space-y-6 bg-background border border-border rounded-lg shadow-xl" onClick={(e) => e.stopPropagation()}>
        ...
        <p className="text-sm text-muted-foreground">This will permanently delete this project. This action cannot be undone.</p>
